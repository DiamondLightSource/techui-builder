...
from phoebusgen.widget.widget import _Generic, _Widget
...
class Label(
    ...
    _p._BackgroundColor,
    _p._Transparent,
    _p._HorizontalAlignment,
    _p._VerticalAlignment,
    _p._RotationStep,
    _p._WrapWords,
    _p._AutoSize,
    _p._Border,
    ...
    def __init__(
        self, name: str, text: str, x: int, y: int, width: int, height: int
    ) -> None:
        """
        Create Label Widget
...
class Picture(_Widget, _p._Macro, _p._File, _p._StretchToFit, _p._Rotation):
    ...
    def __init__(
        self, name: str, file: str, x: int, y: int, width: int, height: int
    ) -> None:
        """
...
class Polygon(
    _Widget, _p._Macro, _p._LineWidth, _p._LineColor, _p._BackgroundColor, _p._Points
):
...
class ByteMonitor(
    ...
    def __init__(
        self, name: str, pv_name: str, x: int, y: int, width: int, height: int
    ) -> None:
        """
...
class Thermometer(
    _Widget, _p._PVName, _p._FillColor, _p._AlarmBorder, _p._LimitsFromPV, _p._MinMax
):
...
class FileSelector(
    _Widget, _p._PVName, _p._FileComponent, _p._AlarmBorder, _p._Enabled
):
...
class XYPlotYAxis(
    StripChartYAxis, _p._TitleFont, _p._ScaleFont, _p._OnRight, _p._Color
):
    def __init__(self) -> None: ...
...
class ColorMapColor(_Generic):
    def __init__(self, value, red, green, blue) -> None: ...
...
class WebBrowser(_Widget, _p._URL, _p._ShowToolbar):
    ...
    def __init__(
        self, name: str, url: str, x: int, y: int, width: int, height: int
    ) -> None:
        """
